...
const sections: TouristSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Cheapest Meals", en: "Asian food courts (Dixon House in Chinatown, Thai Town at Campbell Street, Korean food court on Pitt Street) serve hearty meals for $10-$15 AUD. Thai, Vietnamese, Korean, and Indian restaurants offer the best value. Sushi trains are $3-$5 AUD per plate.", ko: "아시안 푸드코트에서 $10-$15 AUD로 든든한 식사 가능. 타이, 베트남, 한국, 인도 레스토랑이 가성비 최고. 스시 트레인은 접시당 $3-$5 AUD." },
            ...
            faqLdJson(
              [
                ...
                },
                {
                  ...
                  a: {
                    en: "The 400 bus from the airport terminals runs to Bondi Junction via the CBD for about $3 AUD with Opal — the best value option. The airport train (T8) is faster but costs $20 AUD–25.",
                  },
                },
              ],
              "tourist"
