...
const faqs = [
  ...
  },
  {
    ...
    a: {
      ...
      ko: "무Budget 여행자: 주 $600–$900 AUD (셰어숙소, 직접 요리, 무료 활동 중심). 중급: 주 $1,200–$2,000 (개인 방, 주 2–3회 외식, 일부 유료 명소). 이는 항공권, 장기 비자 비용, 건강보험을 제외한 금액입니다. 생활비 상세 비교는 numbeo.com에서.",
    },
    bg: "bg-cyan-50",
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-4">
        {faqs.map((faq, i) => (
          <div key={i} className={`${faq.bg} border-4 border-black p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] ${faq.border} border-l-8`}>
            <h2 className="font-black text-base text-stone-900 mb-3">
              <En>{faq.q.en}</En>
              <Ko>{faq.q.ko}</Ko>
            </h2>
      ...
      <div className="mt-10 p-5 bg-stone-100 border-4 border-black">
        <p className="text-sm text-stone-600">
          <En>Can&apos;t find your question? Email us at </En>
          <Ko>원하는 답변이 없으세요? </Ko>
          <span className="font-black text-stone-900">hello@aussiemate.com.au</span>
