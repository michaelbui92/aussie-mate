...
const sections: SportSection[] = [
  {
    ...
    img: "https://images.pexels.com/photos/23947874/pexels-photo-23947874.jpeg?auto=compress&cs=tinysrgb&w=1200",
    items: [
      ...
      { label: "Rugby Union", en: "Rugby Union is more niche but has a loyal following. The national competition is Super Rugby (12 teams from NZ, Australia, Argentina, South Africa). NSW Waratahs play out of Sydney Football Stadium (Allianz Stadium) at Moore Park. International matches (Wallabies) are played at ANZ Stadium or the SCG. International Rugby (Test) matches against New Zealand (All Blacks) or South Africa (Springboks) are incredible events — the atmosphere rivals anything in the world. Tickets from ~$40 AUD.", ko: "럭비 유니온은 더 전문적이지만 충성스러운 팬층이 있습니다. 전국 대회인 Super Rugby에는 NZ, 호주, 아르헨티나, 남아프리카의 12개 팀이 참가합니다. NSW Waratahs는 시드니 풋볼 스타디움(Allianz Stadium)에서 경기합니다. 국제 경기(월러비)는 ANZ 스타디움이나 SCG에서 열립니다. 뉴질랜드(올 블랙스)나 남아프리카(스프링복스)와의 국제 경기는 정말훌륭한 events입니다." },
    ],
  },
  {
    id: "cricket",
    ...
    img: "https://images.pexels.com/photos/13509965/pexels-photo-13509965.jpeg?auto=compress&cs=tinysrgb&w=1200",
    items: [
  ...
  },
  {
    ...
    img: "https://images.pexels.com/photos/9030300/pexels-photo-9030300.jpeg?auto=compress&cs=tinysrgb&w=1200",
    items: [
      ...
      { label: "Tennis", en: "The Australian Open in Melbourne (January) is one of the four Grand Slam tournaments and draws huge crowds. It's also the most accessible Grand Slam — grounds passes start around $50 AUD, and you can watch multiple matches simultaneously on outer courts. Sydney hosts the Sydney Tennis International (ATP/WTA) in January at the Sydney Olympic Park Tennis Centre. Public tennis courts are available in most parks — book via Inner West Council or your local council website for ~$15-$20 AUD/hour.", ko: "호주 오프연고qq Melbourne의 호주 오프연고qq(1월)는 4대 그랜드 슬램 대회 중 하나이며 많은 군중을 끌어 모읍니다. 가장 접근하기 쉬운 그랜드 슬램이기도 합니다 — 그라운드 패스는 약 $50 AUD부터, 외부코트에서 여러 경기를 동시에 볼 수 있습니다. 시드니는 시드니 올림피아크 파크 테니스 센터에서 1월에 시드니 테니스 인터내셔널(ATP/WTA)을 개최합니다. 공공 테니스 코트는 대부분의 공원에서 이용 가능하며, 지역 의회 웹사이트에서 약 $15-$20 AUD/시간에 예약할 수 있습니다." },
  ...
  },
  {
    ...
    img: "https://images.pexels.com/photos/35047883/pexels-photo-35047883.jpeg?auto=compress&cs=tinysrgb&w=1200",
    items: [
