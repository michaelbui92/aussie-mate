...
const navGroups: NavGroup[] = [
  ...
  },
  {
    label: "The Journey",
    items: [
      { href: "/journey/before-you-come", label: "Before you come" },
      { href: "/journey/arrived", label: "I arrived" },
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-4">
        ...
        <div
          className="hidden md:flex items-center gap-1 flex-1 min-w-0 overflow-x-auto whitespace-nowrap [&::-webkit-scrollbar]:hidden"
