      ...
      <div className="max-w-2xl mx-auto px-4">
        <div className="glass-card rounded-2xl px-4 py-5 mb-4 inline-block">
          <div className="flex items-center justify-center gap-2 mb-2">
            <span className="text-2xl" dangerouslySetInnerHTML={{ __html: ICONS.kangaroo }} />
          ...
          <p className="text-sm text-eucalypt/50 dark:text-dark-muted/50 mb-3">
            Made with <span className="inline-block w-4 h-4 align-middle" dangerouslySetInnerHTML={{ __html: ICONS.kangaroo }} /> for everyone new to Australia
          </p>
          {/* AI Disclaimer */}
