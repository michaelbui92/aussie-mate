      ...
      <section className="mb-8">
        ...
        <div className="space-y-3">
          {[
            ...
            { en: "Planning ahead", ko: "장기 계획", desc: { en: "PR pathways, partner visas, citizenship. These take years. If it's in your plans, start understanding the process now.", ko: "영주권 루트, 파트너 비자, 시민권.这些都是需要数年的时间. 계획에 있다면 지금부터 프로세스를 이해하세요." }, href: "/resources" },
          ].map((item) => (
