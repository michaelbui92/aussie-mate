...
const sections: TransportSection[] = [
  {
    ...
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Opal_Card_with_mytrain_paper_tickets.jpg/1280px-Opal_Card_with_mytrain_paper_tickets.jpg",
    items: [
      ...
      { label: "Daily Cap", en: "Opal has a daily cap — you can't be charged more than a certain amount per day. For Adult Opal in Sydney, the cap is around $16 AUD-18/day (train, bus, ferry, light rail combined). Concession cards have lower caps. Weekly caps also apply after 8 journeys.", ko: "Opal에는 일일 상한선이 있습니다 — 하루에 정해진 금액 이상으로는 부과되지 않습니다. 시드니 Adult Opal의 경우 약 $16 AUD-18/일(기차, 버스, 페리, 라이트 레일 combined). Concession 카드는 더 낮은 상한선이 있습니다. 8회 이후에는 주간 상한선이 적용됩니다." },
      { label: "Auto-reload", en: "Set up auto-reload so you never run out of balance. When your balance drops below $10 AUD, it automatically tops up from your credit/debit card. You can also tap your card at partner shops (Coles, Newsagents) to reload in person.", ko: "잔고가 떨어지지 않도록 자동 충전을 설정하세요. 잔고가 $10 AUD 이하로 떨어지면 자동으로 신용/직불 카드에서 충전됩니다. 파트너 매장(Coles, 신문판매대)에서 카드를 탭해서 직접 충전할 수도 있습니다." },
  ...
  },
  {
    ...
    img: "https://upload.wikimedia.org/wikipedia/commons/d/d9/Waratah_Series_1_%28A_Set%29_at_Sydney_Central_Station.jpg",
    items: [
