...
const sections: BeachSection[] = [
  {
    ...
    items: [
      ...
      { label: "Icebergs Pool", en: "The famous ocean pool at Bondi's southern end. Entry is about $9 for adults. The pool is filled by ocean waves — cold but refreshing. Great photo spot overlooking the beach. Open every day except Christmas. The attached restaurant is a great spot for brunch.", ko: "Bondi 남쪽 끝에 있는 유명한 바다 수영장입니다. 입장료는 성인 약 $9입니다. 파도로 채워지는 수영장 — 차갑지만 상쾌합니다. 해변을 내려다보는 멋진 사진 명소입니다. 크리스마스 외에는 매일 운영합니다." },
    ],
  },
  {
    id: "manly",
    ...
    items: [
      { label: "How to Get There", en: "Take the F1 ferry from Circular Quay to Manly Wharf — a 30-minute scenic ride across the harbour. Opal fare is about $11 each way. This is one of the best value experiences in Sydney. Alternatively, take the L90 bus from Wynyard Station (1 hour, cheaper but less scenic).", ko: "Circular Quay에서 Manly Wharf까지 F1 페리를 타세요 — 항구를 가로지르는 30분의 경치 좋은 항해입니다. Opal 요금은 편도 약 $11입니다. 시드니에서 가장 가성비 좋은 경험 중 하나입니다. 또는 Wynyard 역에서 L90 버스(1시간, 저렴하지만 경치는 덜함)를 탈 수 있습니다." },
  ...
  },
  {
    ...
    items: [
      { label: "How to Get There", en: "Take the L90 bus from Wynyard Station (about 1.5 hours, Opal fare ~$5) or drive north via the A3 and Barrenjoey Road. The L90 runs along the coast past Dee Why, Collaroy, Mona Vale, and Newport before reaching Palm Beach. Driving from the CBD takes about 50 minutes outside peak times.", ko: "Wynyard 역에서 L90 버스(약 1.5시간, Opal 요금 약 $5)를 타거나 A3와 Barrenjoey Road를 통해 북쪽으로 운전하세요. L90은 Dee Why, Collaroy, Mona Vale, Newport를 지나 해안을 따라 Palm Beach까지 운행됩니다. CBD에서 운전하면 피크 타임 외에 약 50분 소요." },
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 md:py-16">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              { labelEn: "Sandy beaches", labelKo: "모래 해변", value: "100+" },
              { labelEn: "UV index (summer)", labelKo: "자외선 지수(여름)", value: "11+ Ext" },
              { labelEn: "Water temp (summer)", labelKo: "수온(여름)", value: "21-24°C" },
              { labelEn: "Bus to Bondi", labelKo: "본다이 버스", value: "333 / 380" },
            ].map((f, i) => (
