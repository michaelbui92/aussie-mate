...
const destinations: BeyondSydneyDestination[] = [
  ...
  },
  {
    ...
    koDesc: "아름다운 해안 디너보트, 훌륭한 해산물, 상징적인 Sea Cliff Bridge가 있는 해변 도시입니다.풍경 drive나 자전거 타기에perfect.",
    ...
    koTransport: "시드니 중앙역에서 기차($10 AUD Opal) — 1.5시간. driving: M1 남쪽으로 90분.",
  ...
  },
  {
    ...
    koDesc: "NSW의 대표적인 와이너리 지역 —완만한 경사 포도원, 부티크 와이너리, 훌륭한 레스토랑, 골프 코스. 편안하고풍경이 좋습니다.",
    ...
    koTransport: "Driving: M1로 2.5시간. 당일치기 투어가 매일 시드니에서 출발합니다($100 AUD-180, 교통편과 시음 포함).",
  ...
  },
  {
    ...
    koTransport: "Central에서 Katoomba까지 기차($18 AUD Opal) — 2시간. driving: M4로 1.5시간.",
    bestTime: "Year-round — dramatic in any season, especially autumn (March-May) for colour",
    koBestTime: "연중 — 어느 계절이든극적이고, 특히 가을(3-5월)에 단풍이 아름답습니다",
    vibe: "nature",
  },
  {
    id: "jervis-bay",
  ...
  },
  {
    ...
    koDesc: "모래 사언덕, 코ala 보호구역, 고래 관찰, 돌고래 크루즈. Stockton Beach의 큰 사장으로 유명합니다.",
  ...
  },
  {
    ...
    koTransport: "시드니에서 비행(1.5시간, 편도~$120 AUD). driving: Pacific Highway로 9시간. 버스: 시드니에서 Greyhound($80 AUD-120).",
