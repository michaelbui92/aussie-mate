...
const sections: Section[] = [
  ...
  },
  {
    ...
    desc: "Korean-Australian organisations and resources in Sydney",
    content: [
      {
        label: "Korean Society of NSW (NSW 한인회)",
        en: "The main Korean community organisation in NSW. They run cultural events, Korean language classes, community festivals, and provide support for new migrants. Located in Campsie and Strathfield areas with a strong Sydney Korean population.",
        ko: "NSW의 주요 한인 커뮤니티 단체입니다. 문화 행사, 한국어 수업, 커뮤니티 축제를 운영하고 신규 이민자를 지원합니다. 시드니 한인 인구가 많은 Campsie와 Strathfield 지역에 기반을 두고 있습니다.",
        url: "https://www.koreansociety.org.au",
        urlLabel: "koreansociety.org.au",
      },
      {
        label: "Korean Community Centre NSW (NSW 한인 커뮤니티 센터)",
        en: "A community centre offering programs for Korean-Australians and new migrants. Services include Korean language and culture programs, settlement support, aged care services, and community events. Great place to connect with the local Korean community.",
        ko: "한국계 호주인과 신규 이민자를 위한 프로그램을 제공하는 커뮤니티 센터입니다. 한국어 및 문화 프로그램, 정착 지원, 노인 복지 서비스, 커뮤니티 행사를 운영합니다. 지역 한인 커뮤니티와 연결되기에 좋은 곳입니다.",
        url: "https://www.kccnsw.org.au",
        urlLabel: "kccnsw.org.au",
      },
      {
        label: "The Korean Herald (코리안 헤럴드)",
        en: "The leading Korean-Australian news source published in English. Covers news about the Korean community in Australia, cultural events, business updates, and immigration-related information. Free online and print editions available in Korean neighbourhoods.",
        ko: "영어로 발행되는 주요 한인 호주 뉴스 매체입니다. 호주 내 한인 커뮤니티 소식, 문화 행사, 비즈니스 업데이트, 이민 관련 정보를 다룹니다. 온라인에서 무료로 이용 가능하며 한인 밀집 지역에서 지면판도 볼 수 있습니다.",
        url: "https://www.koreanherald.com.au",
        urlLabel: "koreanherald.com.au",
      },
      {
        label: "KBS World Radio (KBS 월드 라디오)",
        en: "Korean language international radio broadcasting from Korea. Available globally via the app, website, and shortwave radio. Great for staying connected with Korean news, music, and culture while living abroad.",
        ko: "한국에서 송출되는 한국어 국제 라디오 방송입니다. 앱, 웹사이트, 단파 라디오를 통해 전 세계에서 청취 가능합니다. 해외 생활 중에도 한국 뉴스, 음악, 문화를 접하기 좋습니다.",
        url: "https://world.kbs.co.kr",
        urlLabel: "world.kbs.co.kr",
      },
      {
        label: "Strathfield Korean Town (스트라스필드 코리안 타운)",
        en: "Strathfield and nearby suburbs (Campsie, Lidcombe, Eastwood) have a strong Korean presence. You'll find Korean supermarkets (e.g. Hanaro Mart, Pos Coo), restaurants, bakeries, clinics with Korean-speaking staff, and Korean churches. The train from Central Station takes about 15-20 minutes.",
        ko: "Strathfield와 인근 교외 지역(Campsie, Lidcombe, Eastwood)에는 한인 밀집 지역이 있습니다. 한인 마트(하나로 마트, Pos Coo), 식당, 빵집, 한국어 가능 직원이 있는 의원, 한인 교회를 찾을 수 있습니다. Central Station에서 기차로 약 15-20분 거리입니다.",
        url: "https://www.sydneychinatown.com.au/suburbs/strathfield",
        urlLabel: "sydneychinatown.com.au",
      },
    ],
  },
  {
