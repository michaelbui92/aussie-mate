...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: Array<{
    ...
    { path: "/experiences/beaches",   priority: 0.8,  changeFrequency: "weekly"  },
    { path: "/experiences/food",      priority: 0.8,  changeFrequency: "weekly"  },
    { path: "/experiences/culture",   priority: 0.8,  changeFrequency: "weekly"  },
    { path: "/experiences/wildlife",  priority: 0.8,  changeFrequency: "weekly"  },
    { path: "/experiences/adventure", priority: 0.8,  changeFrequency: "weekly"  },
    { path: "/experiences/road-trips",priority: 0.8,  changeFrequency: "weekly"  },
    { path: "/finance",               priority: 0.8,  changeFrequency: "monthly" },
    { path: "/transport",             priority: 0.8,  changeFrequency: "monthly" },
    { path: "/cost-of-living",        priority: 0.8,  changeFrequency: "monthly" },
    ...
    { path: "/journey/before-you-come", priority: 0.7, changeFrequency: "monthly" },
    { path: "/journey/arrived",       priority: 0.7,  changeFrequency: "monthly" },
    { path: "/journey/home",          priority: 0.7,  changeFrequency: "monthly" },
