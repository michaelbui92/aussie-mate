...
const sections: FinanceSection[] = [
  {
    ...
    img: "/images/unsplash-1554224155-6726b3ff858f.jpg",
    items: [
  ...
  },
  {
    ...
    items: [
      { label: "Weekly Budget Estimate", en: "As a student in Sydney, expect to spend $300 AUD-500 per week on basics (rent, food, transport, phone). Rent alone is $180 AUD-300 depending on location and sharing. This varies a lot — regional areas are much cheaper than Sydney.", ko: "시드니 학생 기준으로 기본 생활비(주거, 식비, 교통, 통신)에 주 $300 AUD-500 정도 필요합니다. 집세만 해도 동네와 룸메이트 구성에 따라 $180 AUD-300입니다. 지역마다 편차가 크며, 지방은 시드니보다 훨씬 저렴합니다." },
      ...
      { label: "Cheap Eats", en: "Sydney has great cheap food. Korean BBQ around Eastwood/Strathfield is affordable. Food courts in Westfield/Chinatown have meals for $10 AUD-15. Learn to cook — beans, rice, eggs, and frozen veggies can feed you for under $40 AUD/week.", ko: "시드니에는 훌륭한 저렴한 음식이 있습니다. 이스트우드/스트라스필드 근처 한국 바비큐는 저렴합니다. Westfield/차이나타운의 푸드코트는 식사가 $10 AUD-15입니다. 요리를 배우세요 — 콩, 밥, 달걀, 냉장 채소로 주당 $40 AUD 이하로 먹을 수 있습니다." },
