...
const sections: FinanceSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "What Happens if You Don't Have One", en: "If you work without a TFN, you'll pay more tax unnecessarily. You can claim it back at tax return time, but it's easier to just get the TFN upfront. Some employers might not hire you without a TFN.", ko: "TFN 없이 일하면 불필요하게 더 많은 세금을 냅니다. 탈세 신고 시 되돌려받을 수 있지만, 첫 이로부 TFN을 받는 게 훨씬훐쉐 처은시니다. 일부 고용주는 TFN 없으면 고용하지 않을 수도 있습니다." },
    ],
  },
  {
    id: "superannuation",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "How It Works", en: "Each financial year runs July 1 to June 30. You lodge your tax return between July 1 and October 31. If you had tax withheld from your pay and earned below $18,200, you'll likely get a full refund. Most students get money back.", ko: "매 회계연도는 7월 1일부터 6월 30일까지입니다. 7월 1이마로 10월 31일 사이에 탈세 신고를 합니다. 급여에서 세금을 원천징수했고 $18,200 이하로 벌었으면 전액 환급을 받을 수 있습니다. 대부분의 학생들이 돈을 돌려받습니다." },
      { label: "Using a Tax Agent", en: "Many students use a tax agent (like H&R Block or a local accountant). They charge $80-150 but often find deductions you missed. First year in Australia — worth using one to learn how it works. After that, you can do it yourself online for free via myTax on the ATO website.", ko: "많은 학생들이 세금 에이전트(H&R Block이나 지역 회계사)를 이용합니다. $80-150가 들지만 자주 놓친 공제분을 찾아줍니다. 호주 첫 해에는와활용하여 제대를 배울면. 그 후에는 ATO 웹사이트의 myTax로 직접 무료로 할 수 있습니다." },
      { label: "Deductions You Can Claim", en: "As a student working part-time, you can claim: work-related travel (if not reimbursed), self-education costs (if work-related), protective clothing/equipment, and union fees. Keep receipts! If you worked from home, you can claim a portion of electricity and internet.", ko: "아르바이트하는 학생으로서 청구할 수 있는 것: 업무 관련 교통비(환급되지 않은 경우), 자기 교육비(업무 관련인 경우), 보호 의류/장비, 조합비. 영수증을보괈하세요! 재택 근무를 했다면 전기와 인터넷 비용의 일부를 청구할 수 있습니다." },
    ],
  },
  {
    id: "centrelink",
  ...
  },
  {
    ...
    items: [
      { label: "Weekly Budget Estimate", en: "As a student in Sydney, expect to spend $300-500 per week on basics (rent, food, transport, phone). Rent alone is $180-300 depending on location and sharing. This varies a lot — regional areas are much cheaper than Sydney.", ko: "시드니에서 학생으로서 기본(임대료, 식비, 교통비, 전화요금)에 주당 $300-500을 쓸 것으로 예상하세요. 임대료만 location과합roommates에 따라 $180-300입니다. 다른 지역은 시드니보다 훨씬 저렴합니다." },
      ...
      { label: "Transportation Savings", en: "Get an Opal card for public transport — always cheaper than paying cash. If you're a full-time student, you can get a Concession Opal card (half price). Work out if a monthly pass is worth it vs pay-as-you-go. Ferries are gorgeous and sometimes the cheapest option!", ko: "대중교통에는 Opal 카드를 이용하세요 — 현금으로 지불하는 것보다 항상 저렴합니다. 전학생이면 Concession Opal 카드(50% 할인)를받을 수 있습니다. 월정액 패스가pay-as-you-go보다 있는지 계산하세요. 페리는경칔도 좋고 때때로 가장 저렴한 옵션입니다!" },
    ],
  },
];

const quickFacts = [
  { labelEn: "Tax-free", labelKo: "비과세", value: "$18,200" },
  { labelEn: "Super rate", labelKo: "퇴직연금", value: "11.5%" },
  { labelEn: "ATM fee", labelKo: "타행 ATM", value: "$2–3" },
  { labelEn: "Weekly budget", labelKo: "주간 예산", value: "$300–500" },
];
