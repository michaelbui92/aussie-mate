  ...
  return (
    <div className="bg-stone-50 dark:bg-darkbg min-h-screen">
      ...
      <section className="relative h-[60vh] min-h-[420px] overflow-hidden">
        <img
          src="https://images.pexels.com/photos/1271619/pexels-photo-1271619.jpeg?auto=compress&cs=tinysrgb&w=1800&q=85"
          alt="Couple walking on a coastal trail with sunglasses"
